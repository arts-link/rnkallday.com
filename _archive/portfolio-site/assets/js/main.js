document.addEventListener("DOMContentLoaded", () => {
    ...
    // Initialize Swiper for the work section
    if (document.querySelector('#gsap_swiper_01')) {
        const swiper = new Swiper('#gsap_swiper_01 .swiper-container', {
            slidesPerView: 'auto',
            spaceBetween: 30,
            centeredSlides: true,
            pagination: {
                el: '#gsap_swiper_01 .swiper-pagination',
                clickable: true,
            },
            breakpoints: {
                640: {
    ...
    // About section cascading text effect
    const aboutSection = document.querySelector('.about-section');
    if (aboutSection) {
        const items = aboutSection.querySelectorAll('ul li');
